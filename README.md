...
<!-- Optional: contribution snake (enable via GitHub Actions if you want) -->
<!--
![snake gif](https://github.com/NobleBa/NobleBa/blob/output/github-contribution-grid-snake.svg)
-->
